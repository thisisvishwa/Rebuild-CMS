 ...
 * are wrapped by this auth guard + shell. The login page (`/admin/login`) is a
 * sibling that does NOT inherit this layout — otherwise `requireAuth()` would
 * redirect the login page to itself and produce an infinite 307 redirect loop.
 */
